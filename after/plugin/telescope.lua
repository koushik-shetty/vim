...
vim.keymap.set('n', '<leader>sw', builtin.grep_string, {desc = 'find word under the cursor'})
vim.keymap.set('n', '<leader>tb', '<Cmd>Telescope builtin<cr>', {desc = 'find word under the cursor'})
